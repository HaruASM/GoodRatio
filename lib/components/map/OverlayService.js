...
// MapIcons 모듈 임포트
import { ICON_TYPES, createIconByIconType } from './MapIcons';
...
const OverlayService = {
  ...
  createMarker: function(coordinates, title, options = {}) {
    ...
    try {
      ...
      // MapIcons.js의 createIconByIconType 함수를 사용하여 마커 요소 생성
      const iconType = options.iconType || ICON_TYPES.DEFAULT;
      const markerElement = createIconByIconType(iconType);
