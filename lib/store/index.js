...
// imageManagerSlice는 imageGallerySlice로 통합됨
import imageGalleryReducer from './slices/imageGallerySlice';
import mapEventReducer from './slices/mapEventSlice';
import exploringSidebarReducer from './slices/exploringSidebarSlice';
...
const combinedReducer = combineReducers({
  ...
  // imageManager 리듀서는 imageGallery로 통합됨
  imageGallery: imageGalleryReducer,
  mapEvent: mapEventReducer,
  exploringSidebar: exploringSidebarReducer
});
