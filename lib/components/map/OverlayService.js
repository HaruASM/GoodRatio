...
const OverlayService = {
  ...
  createStreetViewEmbedUrl: function(streetViewInfo) {
    ...
    try {
      // 기본 임베드 URL 형식으로 변환
      return `https://www.google.com/maps/embed?pb=!4v1744375904548!6m8!1m7!1s${streetViewInfo.panoid}!2m2!1d0!2d0!3f${streetViewInfo.heading || 0}!4f${streetViewInfo.pitch || 0}!5f${streetViewInfo.fov || 90}`;
    } catch (error) {
